      ...
      <nav className="bg-white border-gray-300 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <Link
              to="#"
              className="text-black border-[2px] bg-orange-600 border-orange-600 hover:bg-transparent transition-all duration-500 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2"
            >
              Get started
            </Link>
          </div>
